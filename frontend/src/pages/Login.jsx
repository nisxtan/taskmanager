...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message?.includes("Admin accounts must use admin login")) {
        alert("Admin Account \n\n Please use admin login page.");
  ...
  const handleGoogleLogin = () => {
    window.location.href = "http://localhost:9009/api/v1/user/google";
  };
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl border border-slate-100">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 text-slate-500 bg-white">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 border-2 border-slate-200 rounded-xl font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center justify-center gap-3 active:scale-95"
        >
